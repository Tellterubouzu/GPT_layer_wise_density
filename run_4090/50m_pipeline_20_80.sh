...
#     --run_dir runs/gpt2_42m_mur_layer20_79_20260113/ 
# python scripts/eval.py \
#     --config configs/eval_scaling/eval_llama_58m.json \
#     --run_dir runs/llama_58m_mur_layer20_79_20260113/ 
# python scripts/eval.py \
#     --config configs/eval_scaling/eval_transformer_pp_51m.json \
#     --run_dir runs/transformer_pp_51m_mur_layer20_79_20260114/

# python3 scripts/plot_results.py \
#   --baseline_dir runs/gpt2_42m_baseline_20260110 \
#   --mur_dir runs/gpt2_42m_mur_layer20_79_20260113 \
#   --out_dir runs/plots/gpt2_42m_mur_20_79

# python3 scripts/plot_results.py \
#   --baseline_dir runs/llama_58m_baseline_20260110 \
#   --mur_dir runs/llama_58m_mur_layer20_79_20260113 \
#   --out_dir runs/plots/llama_58m_mur_20_79

python3 scripts/plot_results.py \
  --baseline_dir runs/transformer_pp_51m_baseline_20260110 \
  --mur_dir runs/transformer_pp_51m_mur_layer20_79_20260114 \
  --out_dir runs/plots/transformer_pp_51m_mur_20_79
